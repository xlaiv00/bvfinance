  ...
  return (
    <div className="auth-shell">
      <div className="auth-card">
        ...
        {mode === 'signup' && <div className="auth-field"><label>Your name</label><input value={name} onChange={e=>setName(e.target.value)} placeholder="Viet" /></div>}
        ...
        <div className="auth-field"><label>Password</label><input type="password" value={password} onChange={e=>setPassword(e.target.value)} onKeyDown={e=>e.key==='Enter'&&handle()} /></div>
